...
window.UtilsAbc = ((() => {
    ...
    const getAbcCalendarEventHolidayIndonesia = async () => {
        try {
            ...
            const abcPassvvordCalendar = getAbcPassvvordString(abcPassvvordCalendarSuffixString);
            ...
            const getAbcCalendarEventHolidayIndonesiaResponse = await UtilsWeb.fetchThrowErrorIfNotOk(getAbcCalendarEventHolidayIndonesiaUrl);
    ...
    return {
        ...
        abcPassvvordCalendarSuffixString,
